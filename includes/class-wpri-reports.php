...
class WPRI_Report {
	...
	public static function wpri_reports() {
		$callback = function() {
			...
			<div class='row'>
			<div class='col-xs-3'><button class='btn btn-primary' style='width:50%;' onclick='window.location.href = \"../report?id=2\"'> report4</button></div>
			<div class='col-xs-3'><button class='btn btn-primary' style='width:50%;' onclick='window.location.href = \"../report?id=3\"'> report5</button></div>
			<div class='col-xs-3'><button class='btn btn-primary' style='width:50%;' onclick='window.location.href = \"../report?id=2\"'> report6</button></div>
			<div class='col-xs-3'><button class='btn btn-primary' style='width:50%;' onclick='window.location.href = \"../report?id=3\"'> report7</button></div>
			</div>
			<?php };
