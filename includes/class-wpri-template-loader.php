 ...
 * @author  Gary Jones
 */
class WPRI_Template_Loader extends Gamajo_Template_Loader {
  /**
   ...
   * @var string
   */
  protected $theme_template_directory = 'wpri';
   ...
   * @var string
   */
  protected $plugin_directory = WPRI_PLUGIN_DIR;
