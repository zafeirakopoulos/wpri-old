...
class WPRI_Admin {
	...
	public function member_fields( $user )
	{
		...
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">University</label></th>';
		echo '<td><textarea id="ms_inst" name="ms_uni" cols="70" rows="1">'. get_user_meta($user,'ms_inst',true) .'</textarea>';
		echo '<span class="description">Write uni/dept name.</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">Program</label></th>';
		echo '<td><textarea id="bs_inst" name="ms_prog" cols="70" rows="1">'. get_user_meta($user,'ms_prog',true) .'</textarea>';
		echo '<span class="description">Write program.</span>';
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">Year</label></th>';
		...
		echo '<tr>';
		echo '<th><label">University</label></th>';
		echo '<td><textarea id="phd_inst" name="phd_uni" cols="70" rows="1">'. get_user_meta($user,'phd_inst',true) .'</textarea>';
		echo '<span class="description">Write uni/dept name.</span>';
		echo '</td></tr>';
		echo '<tr>';
		echo '<th><label">Program</label></th>';
		echo '<td><textarea id="bs_inst" name="phd_prog" cols="70" rows="1">'. get_user_meta($user,'phd_prog',true) .'</textarea>';
		echo '<span class="description">Write program.</span>';
		echo '</td></tr>';
	 	echo '<tr>';
		echo '<th><label">Year</label></th>';
