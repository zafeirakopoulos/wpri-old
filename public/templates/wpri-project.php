...
<div class="member">
	<div class="container">
		...
		?>
		<div class='row'>
			<div class='col-sm-12 col-md-12 col-lg-12'><h1> <?php echo $project['title'];?></h1> </div>
		</div>
		<div class='row'>
			<div class='col-sm-3 col-md-3 col-lg-3'> <?php echo "project picture"?> </div>
			<div class='col-sm-3 col-md-3 col-lg-3'> <?php echo $member['position'];?> </div>
		</div>
		<div class='row'>
			<div class='col-sm-3 col-md-3 col-lg-3'> <?php echo $project["funding"];?> </div>
