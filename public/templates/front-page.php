        ...
        <div class="col-xs-12 col-md-9">
            <ul class="list-group">
                <li class="list-group-item">
     			  <h3> Gebze Technical University Institute of Information Technologies (GTU IIT) conducts qualified research and development activities at national and international level with an industrial perspective.
    			   <br>
