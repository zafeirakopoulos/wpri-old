...
<div class="container main-content-container">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-9">
            <ul class="list-group">
                <div class="list-group-item-alt">
                    <h2 class="list-group-item-alt">
                        <?php _e("Gebze Technical University Institute of Information Technologies (GTU IIT) conducts qualified research and development activities at national and international level with an industrial perspective.
         			   <br><br>
         			   ...
         			   <br><br>
         			   With national and international collaborations, personnel movement and creation of policies, GTU IIT positions itself as the center of attraction.","wpri") ?>

                     </h2>
                </div>
           </ul>
		   <h1 class='outfont'><?php _e("Highlights","wpri") ?> </h1><br>
		   <?php $args = array(
				 'posts_per_page' => 20,
